...
After that was the ranking process which was a discussion on what was deemed the most important and least important to the project design. Durability, and user engagement were given three stars, accuracy was given two stars, and convenience/safely was given one star. Durability and user engagement/experience got three stars because those were highlighted the most in the benchmarking. The accuracy deserved two stars because it is not quite as essential as the above groups. The convenience/safety were 1 star because they are not as important as the other categories since it is not a hazardous product and most customers purchasing this product expect some setup. Overall, the user needs process was very useful in helping the understanding of what the customers wanted. 
